...
blur_image = cv2.GaussianBlur(image, (9, 9), sigmaX=5, sigmaY=5)
...
# high_threshold = 150
# L2gradients = True
# edges = cv2.Canny(blur_image, lower_threshold, high_threshold, L2gradient=L2gradients)
