...
class SlingDataset(Dataset):
    def __init__(self, dir_path, width, height, classes, transforms=None):
        ...
        self.all_images = [
            image_path.split("/")[-1].split("\\")[-1] for image_path in self.image_paths
        ]
...
train_dataset = SlingDataset(
    TRAIN_DIR, RESIZE_TO_WIDTH, RESIZE_TO_HEIGHT, CLASSES, get_train_transform()
)
valid_dataset = SlingDataset(
    VALID_DIR, RESIZE_TO_WIDTH, RESIZE_TO_HEIGHT, CLASSES, get_valid_transform()
)
...
if __name__ == "__main__":
    ...
    dataset = SlingDataset(TRAIN_DIR, RESIZE_TO_WIDTH, RESIZE_TO_HEIGHT, CLASSES)
    ...
    for i in range(25, 25 + NUM_SAMPLES_TO_VISUALIZE):
